...
class ResourceTimelineGrid extends internal_cjs.DateComponent {
    ...
    render() {
        ...
        let { unit: timerUnit, value: timeUnitValue } = internal_cjs.greatestDurationDenominator(tDateProfile.slotDuration);
        ...
        return (preact_cjs.createElement("div", { ref: this.handleEl, className: [
            ...
            preact_cjs.createElement(internal_cjs.NowTimer, { unit: timerUnit, unitValue: timeUnitValue }, (nowDate, todayRange) => (preact_cjs.createElement(preact_cjs.Fragment, null,
